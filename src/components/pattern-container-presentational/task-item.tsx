...
export default function TaskItem({ task }: TaskItemProps) {
	...
	const { deleteTask, completeTask, editTask } = useStore();
	...
	return (
		...
		>
			...
			<Button variant='destructive' size='sm' onClick={() => deleteTask(task.id)} data-testid='delete-btn'>
				Delete
			</Button>
		</div>
	);
